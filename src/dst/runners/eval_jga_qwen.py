"""
Evaluate Qwen2.5-7B-Instruct on the DST task using Joint Goal Accuracy.
...
def main():
    ap = argparse.ArgumentParser(description="Evaluate Qwen2.5 DST model with JGA.")
    ap.add_argument("--path", required=True, help="JSONL split file, e.g. data_unified/multiwoz24/val.jsonl")
    ap.add_argument("--model", default=QwenDSTModel.DEFAULT_MODEL,
                    help="HF model name or local folder (default: Qwen/Qwen2.5-7B-Instruct)")

#!/usr/bin/env bash
# train_llama4_maverick_17b_twostage.sh — Two-stage LoRA fine-tuning with Llama 4 Maverick 17B
#
...
#
# Usage:
#   HF_TOKEN=hf_... bash scripts/train_llama4_maverick_17b_twostage.sh luas
#   HF_TOKEN=hf_... bash scripts/train_llama4_maverick_17b_twostage.sh d0t
#
# Arguments:
...
if [ -z "${HF_TOKEN:-}" ]; then
    ...
    echo "Then run: export HF_TOKEN=hf_... && bash scripts/train_llama4_maverick_17b_twostage.sh luas"
    exit 1
fi
...
if [ -z "$DATASET" ]; then
    ...
    echo "Usage: bash scripts/train_llama4_maverick_17b_twostage.sh [luas|d0t]"
    exit 1
fi
...
STAGE1_DIR="runs/llama4_maverick_17b_stage1_${DATASET}_128k"
STAGE2_DIR="runs/llama4_maverick_17b_stage2_${DATASET}_to_mwoz"

echo
echo "============================================"
echo "TWO-STAGE LLAMA 4 MAVERICK 17B FINE-TUNING"
echo "============================================"
